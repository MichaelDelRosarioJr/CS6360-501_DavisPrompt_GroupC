...
public class FileHandler {
    ...
    public static void initializeDataStore() {
        ...
        try {
			...
			TableTree davisTable = new TableTree(CATALOG_TABLE, DatabaseType.CATALOG);
			/** Create davisbase_columns system catalog */
			TableTree davisColumns = new TableTree(CATALOG_COLUMN, DatabaseType.CATALOG);
		} catch (IOException e) {
    ...
    public static boolean createTable(String tableName, DatabaseType dt) {
    	return createTableFile(tableName);
    }
